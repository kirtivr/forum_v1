# Generated by Django 3.2.18 on 2023-05-15 07:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('language', models.CharField(blank=True, choices=[('hindi', 'Hindi'), ('english', 'English'), ('jp', 'Japanese'), ('CN', 'Mandarin')], default='enflish', help_text='Language', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='posts.book')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='posts.Genre'),
        ),
    ]
