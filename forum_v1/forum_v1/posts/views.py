...
class LoanedBooksByUserListView(LoginRequiredMixin, generic.ListView):
    ...
    model = BookInstance
    template_name = 'posts/bookinstance_list_borrowed_user.html'
    paginate_by = 10
...
#@permission_required('posts.can_mark_returned', raise_exception=True)
...
from posts.forms import RenewBookForm
...
def renew_book_librarian(request, pk):
    ...
    return render(request, 'posts/book_renew_librarian.html', context)
